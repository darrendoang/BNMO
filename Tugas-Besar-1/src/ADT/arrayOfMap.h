...
Map GetElmtArrayMap(TabMap T, IdxTypeArrayMap i);
...
/* Assignment THsl -> Tin */
void SetElArrayMap(TabMap *T, IdxTypeArrayMap i, Map v);
...
void InsertFirst(TabMap *T, Map v);
/* I.S. T terdefinisi, mungkin kosong. */
/* F.S. v menjadi elemen pertama T. */

void InsertAt(TabMap *T, Map v, IdxTypeArrayMap i);
...
void InsertLast(TabMap *T, Map v);
/* I.S. T terdefinisi, mungkin kosong. */
